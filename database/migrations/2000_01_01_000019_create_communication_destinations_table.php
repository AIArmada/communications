...
return new class extends Migration
{
    public function up(): void
    {
        ...
        commerce_schema_create_if_missing(config('communications.database.tables.destinations', 'communication_destinations'), function (Blueprint $table) use ($jsonType): void {
