...
return new class extends Migration
{
    public function up(): void
    {
        ...
        commerce_schema_create_if_missing(config('communications.database.tables.suppressions', 'communication_suppressions'), function (Blueprint $table) use ($jsonType): void {
