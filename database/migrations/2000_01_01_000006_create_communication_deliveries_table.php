...
return new class extends Migration
{
    public function up(): void
    {
        ...
        commerce_schema_create_if_missing(config('communications.database.tables.deliveries', 'communication_deliveries'), function (Blueprint $table) use ($jsonType): void {
