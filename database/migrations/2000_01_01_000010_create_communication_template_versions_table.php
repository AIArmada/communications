...
return new class extends Migration
{
    public function up(): void
    {
        ...
        commerce_schema_create_if_missing(config('communications.database.tables.template_versions', 'communication_template_versions'), function (Blueprint $table) use ($jsonType): void {
