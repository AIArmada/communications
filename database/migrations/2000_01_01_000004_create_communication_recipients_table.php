...
return new class extends Migration
{
    public function up(): void
    {
        ...
        commerce_schema_create_if_missing(config('communications.database.tables.recipients', 'communication_recipients'), function (Blueprint $table) use ($jsonType): void {
